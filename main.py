...
BOT1_TOKEN = "8973551149:AAE5le4WZ9no6mf4bJ9Ik8by-LlbNFfxqz8"
BOT2_TOKEN = "8904735821:AAFSloXROv1dN_6VPcGk_77pHDmuDVV5znE"
...
async def get_city(update, context):
    ...
    await update.message.reply_text("📱 Отлично! Последний шаг — напиши своё имя / @тг и номер телефона.")
    return CONTACT
...
async def main():
    app1 = build_app(BOT1_TOKEN)
    app2 = build_app(BOT2_TOKEN)
